...
CLASS2LABEL_GLOBAL = {
        'divider_solid_white': 0,
        'divider_dashed_white': 1,
        'divider_solid_yellow': 2,
        'divider_dashed_yellow': 3,
        'ped_crossing': 4,
        'boundary_fence': 5,
        'boundary_curb': 6,
        'centerline': 7,
        'stopline': 8,
        'road_marking': 9,
        'road_marking_straight': 10,
        'road_marking_left': 11,
        'road_marking_right': 12,
        'road_marking_uturn': 13,
        'road_marking_straight_left': 14,
        'road_marking_straight_right': 15,
        'others': -1
    }
...
class LiDARInstanceLines(object):
    ...
    def shift_fixed_num_sampled_points_v2(self):
        ...
        for idx, instance in enumerate(self.instance_list):
            ...
            if 'centerline' in CLASS2LABEL_GLOBAL.keys() and instance_label == CLASS2LABEL_GLOBAL['centerline']:
...
class VectorizedAV2LocalMap(object):
    CLASS2LABEL = CLASS2LABEL_GLOBAL
    def __init__(self,
                 canvas_size, 
                 patch_size,
...
class CustomRuqiOfflineLocalMapDataset(CustomNuScenesDataset):
    r"""NuScenes Dataset.
