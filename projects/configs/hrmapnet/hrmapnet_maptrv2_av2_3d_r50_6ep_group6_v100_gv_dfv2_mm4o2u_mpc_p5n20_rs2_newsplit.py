...
map_cfg = dict(
    ...
    use_map_prior=True,
    load_gt_map_path="data/argoverse2/sensor/av2_map_infos_trainval.json",
...
data = dict(
    ...
    train=dict(
        type=dataset_type,
        data_root=data_root,
        ann_file=data_root + 'av2_map_infos_train_newsplit.pkl',
        z_cfg=z_cfg,
    ...
    val=dict(
        type=dataset_type,
        data_root=data_root,
        ann_file=data_root + 'av2_map_infos_val_newsplit.pkl',
        map_ann_file=data_root + 'av2_gt_map_anns_val_i4_3d_newsplit.json',
        # code_size=3,
        z_cfg=z_cfg,
