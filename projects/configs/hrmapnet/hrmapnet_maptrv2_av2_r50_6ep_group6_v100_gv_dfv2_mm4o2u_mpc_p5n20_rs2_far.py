...
map_cfg = dict(
    ...
    code_size=2,
    inv_smoothness=[1.0, 0.5, 1.0],    # [40, 2, 40]
    use_map_prior=True,
    load_gt_map_path="data/argoverse2/sensor/av2_lr_map_infos_trainval.json",
...
data = dict(
    ...
    train=dict(
        type=dataset_type,
        data_root=data_root,
        ann_file=data_root + 'av2_lr_map_infos_train.pkl',
        z_cfg=z_cfg,
    ...
    val=dict(
        type=dataset_type,
        data_root=data_root,
        ann_file=data_root + 'av2_lr_map_infos_val.pkl',
        map_ann_file=data_root + 'av2_lr_gt_map_anns_val_i4.json',
        # code_size=3,
        z_cfg=z_cfg,
    ...
    test=dict(
        ...
        classes=class_names,
        modality=input_modality),
    shuffler_sampler=dict(type='DistributedGroupSampler', partial=4),
