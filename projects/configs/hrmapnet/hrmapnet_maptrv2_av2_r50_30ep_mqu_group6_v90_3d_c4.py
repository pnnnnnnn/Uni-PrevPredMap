...
map_cfg = dict(
    ...
    save_map_path="./work_dirs/hrmapnet_maptrv2_av2_r50_30ep_mqu_group6_v100_3d_c4/test_map_mini.pt",    # "./work_dirs/hrmapnet_maptrv2_av2_r50_30ep/test_map.pt"
    update_map=True,
...
dataset_type = 'CustomAV2OfflineLocalMapDatasetV2'
...
data = dict(
    ...
    train=dict(
        type=dataset_type,
        data_root=data_root,
        ann_file=data_root + 'av2_c4_map_infos_train_filtered.pkl',
        z_cfg=z_cfg,
    ...
    val=dict(
        type=dataset_type,
        data_root=data_root,
        ann_file=data_root + 'av2_c4_map_infos_val_filtered.pkl',
        map_ann_file=data_root + 'av2_c4_gt_map_anns_val_filtered_i5.json',
        # code_size=3,
        z_cfg=z_cfg,
    ...
    test=dict(
        ...
        data_root=data_root,
        ann_file=data_root + 'av2_c4_map_infos_val_filtered.pkl',
        map_ann_file=data_root + 'av2_c4_gt_map_anns_val_filtered_i500.json',
        # code_size=3,
        z_cfg=z_cfg,
        load_interval=500,  # av2 uses 10 Hz, set to 5, 2HZ the same as nuscenes,
        # load_interval=1, # TODO debug
        pipeline=test_pipeline,
        bev_size=(bev_h_, bev_w_),
        pc_range=point_cloud_range,
