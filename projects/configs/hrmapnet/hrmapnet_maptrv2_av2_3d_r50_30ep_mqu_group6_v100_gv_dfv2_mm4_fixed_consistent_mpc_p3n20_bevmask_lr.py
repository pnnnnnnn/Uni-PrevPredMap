...
map_cfg = dict(
    ...
    use_map_prior=True,
    load_gt_map_path="/defaultShare/autoPilot/pengnan/data/ArgoVerse2/sensor/av2_lr_map_infos_trainval.json",
...
data = dict(
    ...
    val=dict(
        ...
        map_ann_file=data_root + 'av2_lr_gt_map_anns_val_2hz_3d.json',
        # code_size=3,
        z_cfg=z_cfg,
