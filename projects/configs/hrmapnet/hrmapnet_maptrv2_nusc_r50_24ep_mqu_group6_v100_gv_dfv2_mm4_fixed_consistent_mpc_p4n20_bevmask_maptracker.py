...
map_cfg = dict(
    ...
    code_size=2,
    inv_smoothness=None,    # [40, 2, 40]
    use_map_prior=True,
    load_gt_map_path="data/nuscenes/nuscenes_map_infos_trainval_maptracker.json",
    inv_smoothness_gt=None,    # [40, 2, 40]
    use_time_prior=True,
...
data = dict(
    ...
    train=dict(
        type=dataset_type,
        data_root=data_root,
        ann_file=data_root + 'nuscenes_map_infos_train_maptracker.pkl',
    ...
    val=dict(
        type=dataset_type,
        data_root=data_root,
        ann_file=data_root + 'nuscenes_map_infos_val_maptracker.pkl',
        map_ann_file=data_root + 'nuscenes_map_anns_val_maptracker.json',
...
# load_from = "./work_dirs/hrmapnet_maptrv2_nusc_r50_24ep_mqu_group6_v100_gv_dfv2_mm4_fixed_consistent_mpc_p4n20_bevmask/epoch_24.pth"
