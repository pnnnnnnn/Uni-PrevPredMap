...
map_cfg = dict(
    ...
    dataset='av2c3',
    load_map_path=None,    # "./work_dirs/hrmapnet_maptrv2_av2_r50_30ep/test_map.pt"
    save_map_path=None,    # "./work_dirs/hrmapnet_maptrv2_av2_r50_30ep/test_map.pt"
    update_map=True,
    ...
    use_map_prior=True,
    load_gt_map_path="/defaultShare/autoPilot/pengnan/data/ArgoVerse2/sensor/av2_maptracker_map_infos_trainval.json",
...
data = dict(
    ...
    train=dict(
        type=dataset_type,
        data_root=data_root,
        ann_file=data_root + 'av2_maptracker_map_infos_train.pkl',
        z_cfg=z_cfg,
    ...
    val=dict(
        type=dataset_type,
        data_root=data_root,
        ann_file=data_root + 'av2_maptracker_map_infos_val.pkl',
        map_ann_file=data_root + 'av2_maptracker_gt_map_anns_val_i4.json',
        # code_size=3,
        z_cfg=z_cfg,
    ...
    test=dict(
        ...
        classes=class_names,
        modality=input_modality),
    shuffler_sampler=dict(type='DistributedGroupSampler', partial=5),
