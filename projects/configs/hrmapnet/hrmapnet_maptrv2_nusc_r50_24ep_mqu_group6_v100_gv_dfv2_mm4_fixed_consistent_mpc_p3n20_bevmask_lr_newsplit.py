...
map_cfg = dict(
    ...
    use_map_prior=True,
    load_gt_map_path="/defaultShare/autoPilot/pengnan/data/NuScenes/nuscenes/nuscenes_lr_map_infos_temporal_trainval.json",
    inv_smoothness_gt=None,    # [40, 2, 40]
    use_time_prior=True,
    map_prior_displacement=0,
    map_prior_minor_revision=0,
...
data = dict(
    ...
    train=dict(
        type=dataset_type,
        data_root=data_root,
        ann_file=data_root + 'nuscenes_lr_map_infos_temporal_train_newsplit.pkl',
    ...
    val=dict(
        type=dataset_type,
        data_root=data_root,
        ann_file=data_root + 'nuscenes_lr_map_infos_temporal_val_newsplit.pkl',
        map_ann_file=data_root + 'nuscenes_lr_map_anns_val_newsplit.json',
