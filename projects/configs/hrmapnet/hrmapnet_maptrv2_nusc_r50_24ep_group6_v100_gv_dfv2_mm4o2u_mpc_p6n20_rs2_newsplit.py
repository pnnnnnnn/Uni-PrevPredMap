...
map_cfg = dict(
    ...
    use_map_prior=True,
    load_gt_map_path="data/nuscenes/nuscenes_map_infos_temporal_trainval.json",
    inv_smoothness_gt=None,    # [1.2, 0.05, 1.2] or None
    use_time_prior=True,
    map_prior_displacement=0,    
    map_prior_minor_revision=20,
...
data = dict(
    ...
    train=dict(
        type=dataset_type,
        data_root=data_root,
        ann_file=data_root + 'nuscenes_map_infos_temporal_train_newsplit.pkl',
    ...
    val=dict(
        type=dataset_type,
        data_root=data_root,
        ann_file=data_root + 'nuscenes_map_infos_temporal_val_newsplit.pkl',
