...
map_cfg = dict(
    ...
    raster_size=[0.50, 0.50],
    dataset='nuscenes',
    load_map_path=None,    # "./work_dirs/hrmapnet_maptrv2_nusc_r50_24ep_mqu_group6_v100_gv_dfv2_mm4_fixed_consistent/test_map.json"
    save_map_path=None,    # "./work_dirs/hrmapnet_maptrv2_nusc_r50_24ep/test_map.pt"
    update_map=True,
    num_classes=num_map_classes,
    global_map_type='vector_tile',    # 'raster' or 'vector' or 'vector_tile'
    tile_size=100,
    tile_interval=0,
    tile_interval_get=50,
    code_size=2,
    inv_smoothness=[1.0, 0.5, 1.0],    # [1.2, 0.05, 1.2] or None
    use_map_prior=True,
    load_gt_map_path="data/nuscenes/nuscenes_lr_map_infos_temporal_trainval.json",
    inv_smoothness_gt=None,    # [1.2, 0.05, 1.2] or None
    use_time_prior=True,
    map_prior_displacement=0,    
    map_prior_minor_revision=12,
    map_prior_major_revision=0,
    map_prior_prob=0.4,
    map_prior_noise=12,
    map_fuse_method='concat',
    use_map_prior_val=False,
    use_time_prior_val=True,
    rasterize_scale=2,
    save_map_prior=None,    # '/pengnan/code/hrmapnet/notebook/unippmap/tmm',
    save_time_prior=None,    # '/pengnan/code/hrmapnet/notebook/unippmap/tt',
)
...
model = dict(
    ...
    pts_bbox_head=dict(
        ...
        use_map_prior=True,    # fuse method concat
        ...
        bbox_coder=dict(
            ...
            voxel_size=voxel_size,
            num_classes=num_map_classes,
            raster_type='defaultvec',
            raster_threshold=0.4,
            raster_threshold_val=0.9,
        ),
...
data = dict(
    ...
    train=dict(
        type=dataset_type,
        data_root=data_root,
        ann_file=data_root + 'nuscenes_lr_map_infos_temporal_train.pkl',
    ...
    val=dict(
        type=dataset_type,
        data_root=data_root,
        ann_file=data_root + 'nuscenes_lr_map_infos_temporal_val.pkl',
        map_ann_file=data_root + 'nuscenes_lr_map_anns_val.json',
